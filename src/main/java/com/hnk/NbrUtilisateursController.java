...
public class NbrUtilisateursController {
    ...
    public void initialize() {
        int total = getNombreUtilisateurs();
     ...
     */
    private int getNombreUtilisateurs() {
        int count = 0;
        String sql = "SELECT COUNT(*) AS utilisateurs FROM utilisateurs";
