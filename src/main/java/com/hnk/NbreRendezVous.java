...
public class NbreRendezVous {
     ...
     */
    int getNombreRendezVous() {
        int count = 0;
        String sql = "SELECT COUNT(*) AS rendezVous FROM rendez_vous";
